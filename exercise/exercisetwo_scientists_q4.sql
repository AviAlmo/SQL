...
--
-- Table structure for table `scientists_q4`
--

DROP TABLE IF EXISTS `scientists_q4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `scientists_q4` (
  `ssn` int NOT NULL,
  `name_scientists` tinytext NOT NULL,
  PRIMARY KEY (`ssn`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `scientists_q4`
--

LOCK TABLES `scientists_q4` WRITE;
/*!40000 ALTER TABLE `scientists_q4` DISABLE KEYS */;
INSERT INTO `scientists_q4` VALUES (123234877,'Michael Rogers'),(152934485,'Anand Manikutty'),(222364883,'Carol Smith'),(326587417,'Joe Stevens'),(332154719,'Mary-Anne Foster'),(332569843,'George ODonnell'),(546523478,'John Doe'),(631231482,'David Smith'),(654873219,'Zacary Efron'),(745685214,'Eric Goldsmith'),(845657245,'Elizabeth Doe'),(845657246,'Kumar Swamy');
/*!40000 ALTER TABLE `scientists_q4` ENABLE KEYS */;
UNLOCK TABLES;
